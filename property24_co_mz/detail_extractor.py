    ...
    while retries:
        try:
            ...
            if token_el:
                ...
                ajax = requests.post(
                    "https://www.property24.co.mz/listing/listingfullcontact",
                    data={
            ...
            ignore_keys = {'Listing Number', 'Type of Property', 'List Date', 'Erf Size', 'Floor Area', 'Street Address', 'Rates and Taxes', 'Zoning', 'Levies', 'Size of farm'}
...
if __name__ == '__main__':
    ...
    s3.put_object(
        ...
        Bucket=BUCKET_NAME,
        Key='logs/property24-co-mz/detail-extractor-logs.txt'
    )
