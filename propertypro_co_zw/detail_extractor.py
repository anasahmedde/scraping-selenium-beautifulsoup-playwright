...
log = logging.getLogger("property-pro-co-zw-detail-extractor")
...
if __name__ == '__main__':
    ...
    s3.put_object(Body=log_stringio.getvalue(), Bucket=bucket_name, Key="logs/property-pro-co-zw/detail-extractor-logs.txt")  
