...
log = logging.getLogger("ghanaPropertyCentre-detail-extractor")
...
if __name__ == '__main__':
    ...
    s3.put_object(Body=log_stringio.getvalue(), Bucket=bucket_name, Key="logs/ghanaPropertyCentre/detail-extractor-logs.txt")
