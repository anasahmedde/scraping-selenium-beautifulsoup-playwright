...
log = logging.getLogger("jiji-co-tz-detail-extractor")
...
if __name__ == '__main__':
    ...
    s3.put_object(Body=log_stringio.getvalue(), Bucket=bucket_name, Key="logs/jiji_co_tz/detail-extractor-logs.txt")
