...
urls = [f"https://nigeriapropertycentre.com/for-rent/short-let?page={i}" for i in range(1, 700)]
urls = [f"https://nigeriapropertycentre.com/for-rent?page={i}" for i in range(1, 1500)]
urls += [f"https://nigeriapropertycentre.com/for-sale?page={i}" for i in range(1, 3500)]
