...
log = logging.getLogger("jiji-com-et-detail-extractor")
...
if __name__ == '__main__':
    ...
    s3.put_object(Body=log_stringio.getvalue(), Bucket=bucket_name, Key="logs/jiji_com_et/detail-extractor-logs.txt")
