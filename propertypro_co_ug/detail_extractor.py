...
log = logging.getLogger("property-pro-co-ug-detail-extractor")
...
if __name__ == '__main__':
    ...
    s3.put_object(Body=log_stringio.getvalue(), Bucket=bucket_name, Key="logs/property-pro-co-ug/detail-extractor-logs.txt")  
