...
log = logging.getLogger("kenyaPropertyCentre-detail-extractor")
...
if __name__ == '__main__':
    ...
    s3.put_object(Body=log_stringio.getvalue(), Bucket=bucket_name, Key="logs/kenyaPropertyCentre/detail-extractor-logs.txt")
