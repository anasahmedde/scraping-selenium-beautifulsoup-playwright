...
log = logging.getLogger("jiji-com-gh-detail-extractor")
...
if __name__ == '__main__':
    ...
    s3.put_object(Body=log_stringio.getvalue(), Bucket=bucket_name, Key="logs/jiji_com_gh/detail-extractor-logs.txt")
