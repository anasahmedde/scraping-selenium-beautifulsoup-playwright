...
log = logging.getLogger("jiji-ng-url-extractor")
...
def fetch_data(slug):
    all_data = []
    url = f"https://jiji.ng/api_web/v1/listing?slug={slug}"
...
with ThreadPoolExecutor(max_workers=threads) as executor:
    ...
    s3.put_object(Body=log_stringio.getvalue(), Bucket=bucket_name, Key="logs/jiji_ng/url-extractor-logs.txt")
