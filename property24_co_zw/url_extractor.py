...
# MongoDB target
DATABASE_NAME   = "property24_co_zw"
...
log = logging.getLogger("property24-zw-url-extractor")
...
def extract_links(url):
    ...
    for a in soup.find_all("a", href=href_re):
        ...
        price_text = a.find_next(string=re.compile(r"\$\s?[\d\s,]+"))
        if price_text:
...
if __name__ == "__main__":
    ...
    s3.put_object(
        ...
        Bucket=BUCKET_NAME,
        Key="logs/property24-co-zw/url-extractor-logs.txt"
    )
