...
DETAIL_COLUMNS = [
    ...
    'price', 'currency', 'beds', 'baths', 'toilets', 'amenities', 'imgUrls',
...
log = logging.getLogger("property24-za-detail-extractor")
    ...
    while retries:
        try:
            ...
            if token_el:
                ...
                ajax = requests.post(
                    "https://www.property24.co.zm/listing/listingfullcontact",
                    data={
            ...
            ignore_keys = {'Listing Number', 'Type of Property', 'List Date', 'Erf Size'}
...
if __name__ == '__main__':
    ...
    s3.put_object(
        ...
        Bucket=BUCKET_NAME,
        Key='logs/property24-co-zm/detail-extractor-logs.txt'
    )
